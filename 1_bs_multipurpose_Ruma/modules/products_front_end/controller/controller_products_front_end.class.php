...
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/utils/response_code.inc.php';
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/utils/filters.inc.php';
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/utils/common.inc.php';
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/classes/Log.class.singleton.php';
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/paths.php';
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/model/Conf.class.singleton.php';
include $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/modules/products_front_end/utils/utils.inc.php';
...
if ((isset($_GET['num_pages'])) && ($_GET['num_pages'] === 'true')) {
    $item_per_page = 3;
    $path_model = $_SERVER['DOCUMENT_ROOT'].'/php/marvelArte_ORM_3/1_bs_multipurpose_Ruma/modules/products_front_end/model/model/';
